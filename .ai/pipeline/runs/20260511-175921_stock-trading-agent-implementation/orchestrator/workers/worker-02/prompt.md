...
Implement G0/G1/G2 in the reviewed AIZen paths only: core contracts, Keychain secret keys, trading skills, tests, and docs. Forbidden paths remain out of scope.
